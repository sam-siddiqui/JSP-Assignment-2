...
<body class="d-flex flex-column flex-grow-1 align-self-stretch">
                            ...
                            <div class="card mb-5">
                                <div class="card-body p-sm-5">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/register">
                                        <div class="d-flex mb-3"><input class="form-control" type="text" id="name-2" name="fname" placeholder="First Name" style="margin-right: 5px;" minlength="2" required=""><input class="form-control" type="text" id="name-4" name="lname" placeholder="Last Name" style="margin-left: 6px;" minlength="2" required=""></div>
                                        <div class="mb-3"><input class="form-control" type="email" id="email-2" name="email" placeholder="Email" inputmode="email" required=""></div>
                                        <div class="mb-3"><input class="form-control" type="text" id="name-1" name="username" placeholder="User Name" required=""></div>
                                        <div class="mb-3"><input class="form-control" type="password" id="password" name="password" placeholder="Password" required=""></div>
                                        <div class="mb-3"><input class="form-control" type="password" id="confirmPassword" name="confirmPassword" placeholder="Confirm Password" required=""></div>
